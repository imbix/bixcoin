...
//		jedisPool = new JedisPool(config, "120.78.201.49", 6379);
		jedisPool = new JedisPool(config, "120.78.201.49", 6379, 30000, "yanning", 0);
	}
...
//		shards.add(new JedisShardInfo("127.0.0.1", 6379, "master"));
		JedisShardInfo jedisShardInfo = new JedisShardInfo("120.78.201.49");
		jedisShardInfo.setPassword("yanning");
	...
	private void SetOperate() {
		 ...
		 * 无实际意义 System.out.println("查看sets集合中的所有元素:"+jedis.smembers("sets"));
		 */
		System.out.println();
